    ...
    fromTree
        ...
        , ( "login"
          , object
                ...
                , ( "Чтобы пользоваться сервисом, вы должны ", string "Чтобы пользоваться сервисом, вы должны " )
                , ( "авторизоваться", string "авторизоваться" )
                , ( "зарегистрироваться", string "зарегистрироваться" )
                , ( "Добавьте Феникс в список наблюдения", string "Добавьте Феникс в список наблюдения" )
                ]
          )
        , ( "list"
          , object
        ...
        , ( "config"
          , object
                ...
                , ( "Изменение местоположения (в режиме Поиск)", string "Изменение местоположения (в режиме ПОИСК)" )
                ...
                , ( "24 часа", string "24 часа" )
                , ( "6 часов", string "6 часов" )
                , ( "Рекомендуется для охраны автомобиля на длительной стоянке.", string "Рекомендуется для охраны автомобиля на длительной стоянке." )
                , ( "Рекомендуется для наиболее вероятного обнаружения угнанного автомобиля.", string "Рекомендуется для наиболее вероятного обнаружения угнанного автомобиля." )
                , ( "Рекомендуется для максимальной экономии энергии батареи питания.", string "Рекомендуется для максимальной экономии энергии батареи питания." )
                , ( "Следующие параметры будут изменены:", string "Следующие параметры будут изменены:")
                , ( "Номер телефона", string "Номер телефона" )
                , ( "Введите номер телефона", string "Введите номер телефона" )
                , ( "Определено автоматически", string "Определено автоматически" )
                , ( "Установлен пользователем", string "Установлен пользователем" )
                ]
          )
        , ( "control"
          , object
        ...
        , ( "map"
          , object
                [ ( "Скрыть трек", string "Скрыть трек" )
                , ( "Закрыть", string "Закрыть" )
                , ( "Последнее положение определено ", string "Последнее положение определено " )
                ]
          )
        , ( "logs"
          , object
        ...
        , ( "dates"
          , object
                ...
                , ( " лет", string " лет" )
                , ( " месяц", string " месяц" )
                , ( " месяца", string " месяца" )
                , ( " месяцев", string " месяцев" )
                , ( " день", string " день")
                , ( " дня", string " дня")
                , ( " дней", string " дней")
                , ( " час", string " час")
        ...
        , ( "status"
          , object
                [ ( "Авто в движении", string "Авто в движении" )
                , ( "Авто в спящем состоянии", string "Авто в спящем состоянии")
                , ( "Состояние еще неизвестно", string "Состояние еще неизвестно")
                , ( "", string "")
                , ( "", string "")
                ]
          )
        , ( "errors"
          , object
                [ ( "Код неверный, уже использован или вышло время действия кода.", string "Код неверный, уже использован или вышло время действия кода." )
                , ( "Неверное имя пользователя или пароль.", string "Неверное имя пользователя или пароль.")
                , ( "Ошибка! Система не существует или у вас недостаточно прав для просмотра.", string "Ошибка! Система не существует или у вас недостаточно прав для просмотра.")
                ]
        )
        ]
