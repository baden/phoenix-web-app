            ...
            [ div [ class "modal-content modal-md" ]
                ...
                , div [ class "modal-body" ]
                    ...
                    , div [ class "input-st modal-input" ]
                        ...
                        , input [ HA.type_ "number", attribute "autocomplete" "off", HA.pattern "[0-9]*", HA.attribute "inputmode" "numeric", HA.value capacity, onInput (OnBatteryChange << BC_Change) ] []
                        ]
                    ]
                , div [ class "modal-btn-group" ]
        ...
        [ div [ class "modal-wr" ]
            [ div [ class "modal-content modal-md" ]
                ...
                , div [ class "modal-body" ]
                    ...
                    , div [ class "input-st modal-input" ]
                        [ span [ class "input-sm-label" ] [ text <| t "config.Укажите начальную емкость батареи (мАч)" ]
                        , input [ HA.type_ "number", attribute "autocomplete" "off", HA.pattern "[0-9]*", HA.attribute "inputmode" "numeric", HA.value capacity, onInput (OnBatteryChange << BC_Capacity) ] []
                        ]
                    ]
                , div [ class "modal-btn-group" ]
                    [ button [ class "btn btn-md btn-secondary modal-close-btn", onClick OnBatteryCapacityCancel ] [ text <| t "config.Отмена" ]
