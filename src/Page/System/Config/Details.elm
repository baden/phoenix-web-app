    ...
    let
        ...
        maybeRowEditable label field foo =
            div [ class "content-item setting-det-phone" ]
                ...
                , Html.button [ class "setting-edit details-edit-btn openModalPhone" ] [ span [ class "icon-edit" ] [] ]
                ]
    in
                    ...
                    , div [ class "content-item" ]
                        [ span [ class "checkmark-wrap setting-executors" ]
                            [ label [ class "checkboxContainer" ]
                                [ input [ attribute "checked" "", name "", type_ "checkbox", value "" ] [], span [ class "checkmark" ] [] ]
